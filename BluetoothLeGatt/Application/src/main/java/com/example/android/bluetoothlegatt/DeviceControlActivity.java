...
public class DeviceControlActivity extends Activity {
   ...
   protected final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                setData(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            }
        }
    };
    ...
    protected void onResume() {
        ...
        mTimer = new Runnable()
        {
            ...
            public void run()
            {
                ...
                mSeries.appendData(new DataPoint(graphLastXValue, yvalue),
                        true, 100);
   ...
   private double setData(String data) {
       if (data != null) {

           yvalue = Double.parseDouble(data);
